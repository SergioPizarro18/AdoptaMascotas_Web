...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // --- Lógica del botón "Continuar" - ALERT REMOVIDO ---
    const btnContinue = document.querySelector('.btn-continue');
    
    if (btnContinue) {
        btnContinue.addEventListener('click', function(e) {
            // No hacer nada especial, el href del botón manejará la redirección
            // Si necesitas lógica adicional antes de redirigir, agrégala aquí
        });
    }
